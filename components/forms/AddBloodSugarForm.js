...
const AddBloodSugarForm = () => {
  ...
  const handleAddRecord = () => {
    if (
      ...
      showAlert('Error', 'Record added successfully');
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.formWrapper}>
        <TextInput
          ...
          onChangeText={e => setFormData({...formData, systolic_pressure: e})}
        ...
        <TextInput
          ...
          style={styles.inputStyle}
          onChangeText={e => setFormData({...formData, diastolic_pressure: e})}
